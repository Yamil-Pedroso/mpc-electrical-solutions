...
const WelcomeToast = () => {
  useEffect(() => {
    const timer = setTimeout(() => {
      toast.custom(
        () => (
          <div className="flex justify-center w-[92vw] max-w-[560px] flex-col items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-xl sm:flex-row sm:items-center sm:gap-5 sm:p-5 sm:text-left">
