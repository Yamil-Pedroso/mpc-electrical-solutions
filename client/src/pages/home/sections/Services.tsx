          ...
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
            {services.map((service, index) => (
              <motion.article
                ...
                className="group relative overflow-hidden rounded-[28px] border border-[#051a37]/8 bg-white p-7 shadow-[0_16px_40px_rgba(5,26,55,0.06)] transition duration-500 hover:-translate-y-2 hover:border-[#da1f27]/18 hover:shadow-[0_24px_60px_rgba(5,26,55,0.12)] sm:p-8"
              >
